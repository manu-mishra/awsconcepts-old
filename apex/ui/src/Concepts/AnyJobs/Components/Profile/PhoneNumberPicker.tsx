  ...
  return (
    ...
    <>
      <div className={rootClass}>
        <label htmlFor={pickerId}>Phone Number</label>
        <TagPicker
          removeButtonAriaLabel="Remove"
          selectionAriaLabel="Selected Phone"
